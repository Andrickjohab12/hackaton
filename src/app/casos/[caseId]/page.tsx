        ...
        <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-center">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {caseData.status === "Pendiente" && (
              <Button className="bg-green-600 hover:bg-green-700">Completar Diagnóstico</Button>
            )}
          </div>
        </div>
          ...
          <Tabs defaultValue="images">
            ...
            <TabsContent value="ai" className="mt-6">
              {caseData.aiAnalysis ? (
                <Card>
                  ...
                  <CardContent className="grid gap-6">
                    <div className="rounded-lg bg-gray-50 p-4">
                      ...
                      <p
                        className={`text-xl font-bold ${caseData.statusColor === "red" ? "text-red-600" : "text-gray-900"}`}
                      >
                        {caseData.aiAnalysis.result}
                      </p>
                      <div className="mt-2 flex items-center">
                        <span className="mr-1 text-sm font-medium">Confianza:</span>
                        <span className="text-sm">{caseData.aiAnalysis.confidence}</span>
                      </div>
                    </div>

                    <div>
                      <h3 className="mb-2 font-medium">Recomendaciones</h3>
                      <p className="text-sm">{caseData.aiAnalysis.recommendations}</p>
                    </div>

                    <div>
                      <h3 className="mb-2 font-medium">Metodología</h3>
                      <p className="text-sm">{caseData.aiAnalysis.comparisons}</p>
                    </div>

                    <div className="flex items-center justify-between rounded-lg border p-4">
                      <div>
                        <h3 className="font-medium">Fecha de análisis</h3>
                        <p className="text-sm text-gray-500">{caseData.aiAnalysis.date}</p>
                      </div>
                ...
                <Card className="p-8 text-center">
                  <p>Este caso aún no ha sido analizado por la IA.</p>
                  <Button className="mt-4 bg-red-600 hover:bg-red-700">Solicitar Análisis de IA</Button>
                </Card>
              )}
            </TabsContent>
